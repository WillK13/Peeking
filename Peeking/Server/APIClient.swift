...
class APIClient {
    ...
    func performAnalysis(userId: String, userType: Int, completion: @escaping (Result<Void, Error>) -> Void) {
        guard let url = URL(string: "http://159.65.221.122:5000/api/perform-analysis") else {
    ...
    func match(userId: String, userType: Int, completion: @escaping (Result<Void, Error>) -> Void) {
            guard let url = URL(string: "http://159.65.221.122:5000/api/match") else {
                completion(.failure(NSError(domain: "", code: -1, userInfo: [NSLocalizedDescriptionKey: "Invalid URL"])))
                return
            }
    ...
    func simpleMatch(userId: String, userType: Int, completion: @escaping (Result<Void, Error>) -> Void) {
            guard let url = URL(string: "http://159.65.221.122:5000/api/simple-match") else {
                completion(.failure(NSError(domain: "", code: -1, userInfo: [NSLocalizedDescriptionKey: "Invalid URL"])))
                return
            }

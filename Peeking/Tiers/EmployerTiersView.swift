...
struct EmployerTiersView: View {
    ...
    private let pagesFloater = [
        ...
        PlanPage(title: "Single Device", description: "Access for one device", imageName: "profile", iconText: ""),
        PlanPage(title: "Single Job Profile", description: "Manage 1 job profile", imageName: "profiles", iconText: ""),
    ...
    private let pagesGlider = [
        ...
        PlanPage(title: "3 Device Access", description: "Invite your team to assist", imageName: "group", iconText: ""),
        PlanPage(title: "Profile +", description: "Manage up to 2 job profiles", imageName: "2profiles", iconText: ""),
    ...
    private let pagesDiver = [
        ...
        PlanPage(title: "Liked You", description: "See job-seekers - liked you", imageName: "Lookeye", iconText: ""),
        PlanPage(title: "5 Device Access", description: "Invite your team to assist", imageName: "group", iconText: ""),
        PlanPage(title: "Profile ++", description: "Manage up to 3 job profiles", imageName: "3profiles", iconText: ""),
        PlanPage(title: "Recharge", description: "Likes recharge 1 every hour", imageName: "Battery", iconText: ""),
            ...
            VStack {
                ...
                VStack {
                    ...
                    if selectedPlan == "with Floater" {
                        ...
                        PaymentOptionsViewEmployers(selectedPlan: selectedPlan)
                            .padding()
                    }
...
struct PaymentOptionsViewEmployers: View {
        ...
        HStack(spacing: 10) {
            ...
            VStack {
                ...
                VStack {
                    ...
                    Text("Save 58%")
                        ...
                        .cornerRadius(5)
                    Text(getPriceEmployers(for: "12 Months"))
                        .font(.title2)
                    Text(getMonthlyPriceEmployers(for: "12 Months"))
                        .font(.caption)
                        .foregroundColor(.gray)
                }
            ...
            VStack {
                ...
                VStack {
                    ...
                    Text("Save 33%")
                        ...
                        .background(Color("TopOrange"))
                        .cornerRadius(5)
                    Text(getPriceEmployers(for: "6 Months"))
                        .font(.title2)
                    Text(getMonthlyPriceEmployers(for: "6 Months"))
                        .font(.caption)
                        .foregroundColor(.gray)
                }
                .frame(width: 80, height: 150)
            ...
            VStack {
                ...
                VStack {
                    ...
                    Text("Month")
                        .font(.subheadline)
                    Text(getPriceEmployers(for: "1 Month"))
                        .font(.title2)
                    Text(getMonthlyPriceEmployers(for: "1 Month"))
                        .font(.caption)
                }
                .frame(width: 80, height: 150)
                .background(Color.white)
    ...
    private func getPriceEmployers(for duration: String) -> String {
        switch selectedPlan {
        case "with Diver":
            switch duration {
            case "12 Months":
    ...
    private func getMonthlyPriceEmployers(for duration: String) -> String {
        switch selectedPlan {
        case "with Diver":
            switch duration {
            case "12 Months":
